...
// [[Rcpp::export]]
NumericMatrix matern_isotropic(NumericMatrix locs,
...
// [[Rcpp::export]]
NumericMatrix matern_sphere(NumericMatrix lonlat,
                              NumericVector covparms){
    ...
    NumericMatrix covmat = matern_isotropic( xyz, covparms );
    return covmat;
}
...
//' Fuentes (2016) argue that 3D embeddings produce reasonable models for data on spheres.
// [[Rcpp::export]]
NumericMatrix matern_sphere_time(NumericMatrix lonlattime,
                           NumericVector covparms){
    ...
    NumericMatrix covmat = matern_isotropic( xyzt, covparms );
    return covmat;
}
