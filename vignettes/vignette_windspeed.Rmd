...
fit_spacetime <- fit_model(windspeed[inds], locstime[inds,], X[inds,], 
    covfun_name = "matern_spheretime", silent = TRUE)
t3 <- proc.time()
fit_space
fit_spacetime
print(t2-t1)
...
# predictions
pred <- predictions(fit_spacetime$covparms, "matern_spheretime", windspeed,
...
sim <- cond_sim(fit_spacetime$covparms, "matern_spheretime", windspeed,
    locstime, locstime_pred, X, X_pred, fit_spacetime$betahat, m = 40)
